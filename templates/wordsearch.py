...
def create(page: Page, entries: list[dict], title: str = "") -> None:
    print("Looking for Word Search template...")
    goto_create(page, "Wordsearch")
    print(f"URL after selecting Word Search: {page.url}")
    ...
    if has_clues:
        ...
        try:
            ...
            try:
                ...
                page.screenshot(path="debug/debug_wordsearch_clues.png")
    else:
        ...
        try:
            ...
            try:
                ...
                page.screenshot(path="debug/debug_wordsearch_no_clues.png")
    ...
    for i, entry in enumerate(entries):
        ...
        try:
            ...
            page.screenshot(path=f"debug/debug_wordsearch_entry_{i+1}.png")
